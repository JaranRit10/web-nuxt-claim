  ...
  <div>
    <div class="page__header">
      <div class="page__title">
        <h1>{{ $t('interface_with_eClaim') }}</h1><span> View </span>
      </div>
      <div class="page__breadcrumb">
        <i class="las la-md la-home"></i> {{ $t('c.home') }} / {{ $t('interace_log') }} / {{ $t('interface_with_eClaim') }}
      </div>
    </div>
      ...
      <b-collapse visible id="interface-file">
        <div class="card-body">
          <b-row align-h="around" class="form-group">
            ...
            <b-col sm="3">
              <label>{{ $t('service_transaction_name') }}</label>
          ...
          >
            ...
            <template slot="tableBody">
              <tr v-for="(v, index) in datasource.data" :key="index">
                ...
                <td class="text-right">{{ v.referenceId }}</td>
                <td class="text-center">{{ v.referenceNo }}</td>
...
export default {
  ...
  data () {
    return {
      ...
      claimTypeList: [],
      statusList: [],
      text2: 'ECLAIM-BILLING-20201104-20:00:00',
  ...
  computed: {
    ...
    columns () {
      const col = [
        { label: this.$t('line_no'), field: 'id', style: {minWidth: '50px', width: '50px' } },
        { label: this.$t('reference_id'), field: 'referenceId', style: {minWidth: '80px', width: '80px' } },
        { label: this.$t('reference_no'), field: 'referenceNo', style: {minWidth: '100px', width: '100px' } },
