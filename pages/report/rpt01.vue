<template>
  <div>
    <HasPerm any="report01_export">
      <!-- Page Header -->
      <div class="page__header">
        <div class="page__title">
          <h1>{{ $t('report') }}</h1> <span>{{ $t('premium_payment') }}</span>
        </div>
        <div class="page__breadcrumb">
          <i class="las la-md la-home"></i> {{ $t('c.home') }}  / {{ $t('report') }} / {{ $t('premium_payment') }}
        </div>
      </div>
      <!-- Search Criteria -->
      <div class="card">
